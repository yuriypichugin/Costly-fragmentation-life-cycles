setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Local simulations/Classes abundance and groups size/Unimodal random delay cost 2020/')
...
Data=read.csv("Combined_Delay_Scan_Unimodal.txt")
