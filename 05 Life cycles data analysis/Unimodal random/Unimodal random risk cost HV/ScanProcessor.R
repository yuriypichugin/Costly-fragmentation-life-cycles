setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Local simulations/Classes abundance and groups size/Unimodal random risk cost 2020 HV/')
...
Data=read.csv("Combined_Risk_Scan_Unimodal.txt")
