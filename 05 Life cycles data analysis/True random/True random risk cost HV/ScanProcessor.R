setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Local simulations/Classes abundance and groups size/True random risk cost 2020/')
...
Data=read.csv("Combined_Risk_Scan.txt")
