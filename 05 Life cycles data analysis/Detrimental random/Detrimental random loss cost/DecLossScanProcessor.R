setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Local simulations/Classes abundance and groups size/Detrimental random loss cost 2020/')
...
Data=read.csv("Combined_Loss_Scan_Detrimental.txt")
...
if(Write2File==1){svg(file = "Dec_ClassesVsLoss_v9.svg", height=pdfSizeY, width=pdfSizeX)}
if(Write2File==2){cairo_pdf(file="Dec_ClassesVsLoss_v9.pdf", height=pdfSizeY, width=pdfSizeX)}
# svg(file="Dec_ClassesVsLoss_v5.svg", height=pdfSizeY, width=pdfSizeX)
...
# DX <- 0.4
# 
# if(Write2File==1){svg(file = "StatisticsSizes_Dec_Loss_v4.svg", height=pdfSizeY, width=pdfSizeX)}
# if(Write2File==2){cairo_pdf(file="StatisticsSizes_Dec_Loss_v4.pdf", height=pdfSizeY, width=pdfSizeX)}
# # svg(file="StatisticsSizes_Dec_Loss_v2.svg", height=pdfSizeY, width=pdfSizeX)
# 
