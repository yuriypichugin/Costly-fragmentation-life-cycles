setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Local simulations/Classes abundance and groups size/Beneficial random risk cost 2020 HV/')
...
Data=read.csv("Combined_Risk_Scan_Beneficial.txt")
...
if(Write2File==1){svg(file = "ClassesVsRisk_v9.svg", height=pdfSizeY, width=pdfSizeX)}
if(Write2File==2){cairo_pdf(file="ClassesVsRisk_v9.pdf", height=pdfSizeY, width=pdfSizeX)}
...
# DX <- 0.4
# 
# if(Write2File==1){svg(file = "StatisticsSizes_Risk_v5.svg", height=pdfSizeY, width=pdfSizeX)}
# if(Write2File==2){cairo_pdf(file="StatisticsSizes_Risk_v5.pdf", height=pdfSizeY, width=pdfSizeX)}
# # svg(file="StatisticsSizes_Risk_v3.svg", height=pdfSizeY, width=pdfSizeX)
# 
