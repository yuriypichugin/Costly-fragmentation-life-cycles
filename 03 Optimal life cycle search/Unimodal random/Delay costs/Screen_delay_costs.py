...
NameFileWrite = 'Results/UnimodalRandom_delay_costs_'+job_id+'.txt'
...
NameFileB = '../Input data/B_profiles_Unimodal_10_'+job_id+'.txt'
NameFileD = '../Input data/D_profiles_Unimodal_10_'+job_id+'.txt'
