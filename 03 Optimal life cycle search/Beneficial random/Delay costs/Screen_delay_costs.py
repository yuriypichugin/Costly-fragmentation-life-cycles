...
NameFileWrite = 'Results/BeneficialRandom_delay_costs_'+job_id+'.txt'
...
NameFileB = '../Input data/B_profiles_Beneficial_'+job_id+'.txt'
NameFileD = '../Input data/D_profiles_Beneficial_'+job_id+'.txt'
