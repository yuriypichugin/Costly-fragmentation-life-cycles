setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Data/Unimodal random loss cost 2020/')
...
write.csv(Data2Write, file="Results_02/Combined_Loss_Scan_Unimodal.txt")
