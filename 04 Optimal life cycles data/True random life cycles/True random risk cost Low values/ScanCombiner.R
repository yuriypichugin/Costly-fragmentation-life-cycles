setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Data/True random risk cost 2020 Low values/')
...
write.csv(Data2Write, file="Results_02/Combined_Risk_Scan.txt")
