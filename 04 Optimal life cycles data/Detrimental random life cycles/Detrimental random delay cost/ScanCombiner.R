setwd('/Volumes/OSX/Users/pichugin/Projects/Fragmentation with costs/Data/Detrimental random delay cost 2020/')
...
write.csv(Data2Write, file="Results_02/Combined_Delay_Scan_Detrimental.txt")
